...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Credit_t, stringdata) + ofs \
...
void Credit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Credit *_t = static_cast<Credit *>(_o);
        switch (_id) {
...
const QMetaObject Credit::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Credit.data,
      qt_meta_data_Credit,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Credit.stringdata))
        return static_cast<void*>(const_cast< Credit*>(this));
